  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      await api.post('/api/expenses', {
        user_id: user?.id,
        amount: montoNum,
        category_id: categoriaId ? Number(categoriaId) : undefined,
        description: descripcion.trim() || undefined,
        expense_date: fecha,
        payment_method: paymentMethod || undefined,
        message_id: messageId ? Number(messageId) : undefined,
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <div className="relative">
            <span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 font-semibold text-lg">L</span>
            <input
              type="number"
              inputMode="decimal"
              step="0.01"
